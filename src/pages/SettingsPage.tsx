          ...
          <>
            ...
            >
              ...
              {activeModal === "Datenschutz" && (
                <div className="flex flex-col gap-4 px-1 pb-4 overflow-y-auto max-h-[50vh] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden bg-[#DBE6E0] dark:bg-[#1E2423] transition-colors">
